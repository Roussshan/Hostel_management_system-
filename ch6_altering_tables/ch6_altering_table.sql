...
-- updating values to the column 
   ...
   UPDATE students set date_of_birth ='1964-09-07', email= 'karan@gmial.com' where student_id=5;
   ...
   UPDATE students set date_of_birth ='2005-05-17', email= 'kunal@gmail.com' where student_id=11;
